...
struct Params {
    ...
    static constexpr int  MM_POS_CAP           = 150;    // |inventory| cap before disabling that side
    ...
    static constexpr long CB_TRIP_CENTS   = -2'500'000;  // -$25k
    static constexpr long CB_RESET_CENTS  = -1'000'000;  // -$10k
};
...
static const std::vector<MMTarget> MM_TARGETS = {
    ...
    {"HKEX",     "ETFB"},  {"HKEX",     "ETFB3"},
    {"Euronext", "ETFSH"}, {"Euronext", "GOLD"},
    {"JPX",      "ETFSH"}, {"JPX",      "GOLD"}, {"JPX", "XAG"},
};
